...
*/
    @RequestMapping(value = "/writefree.do")
    public String writeFree() throws SQLException, ClassNotFoundException {
    	return "writeFree";
    }
    @RequestMapping(value = "/writeEditor.do")
    public String getEditor() throws SQLException, ClassNotFoundException {
    	return "writeEditor";
    }
    @RequestMapping(value = "/freeContent.do")
    public String infreeContent(ContentVO vo, Model model) throws ClassNotFoundException, SQLException {
    	System.out.println(vo.getText());
    	model.addAttribute("infreeboard", boardService.insertContent(vo));
